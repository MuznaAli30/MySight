  ...
  return (
    <>
      ...
      <div className="bg-[#ffffff] flex flex-col h-screen">
        {/* Header Section */}
        <div className="flex justify-center font-serif mb-5 font-semibold items-center flex-row max-sm:flex-col mt-16">
          <MdOutlineSelfImprovement className="text-8xl text-[#bfaeae]" />
          <div className="text-4xl font-montserrat max-sm:text-xl max-sm:justify-center max-sm:flex">
        ...
        {/* Input Section */}
        <div className="flex p-4 flex-row max-lg:flex-col border-t bg-[#f8f1f1]  max-sm:w-[95%] rounded-lg w-[90%] m-auto justify-center">
          <input
            type="text"
            value={Message}
